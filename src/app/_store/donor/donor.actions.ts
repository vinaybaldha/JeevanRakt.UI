...
export const addDonorSuccess = createAction(ADD_DONOR_SUCCESS)

export const updateDonor = createAction(UPDATE_DONOR,props<{inputData: Donor}>())
export const updateDonorSuccess = createAction(UPDATE_DONOR_SUCCESS)

export const deleteDonor = createAction(DELETE_DONOR,props<{donorId:string}>())
export const deleteDonorSuccess = createAction(DELETE_DONOR)
