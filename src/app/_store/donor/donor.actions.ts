...
export const loadDonor = createAction(LOAD_DONOR)
export const loadDonorSuccess = createAction(LOAD_DONOR_SUCCESS,props<{list:Donor[]}>())
export const loadDonorFail = createAction(LOAD_DONOR_FAIL,props<{errormessage:string}>())

export const addDonor = createAction(ADD_DONOR,props<{inputData: Donor}>())
export const addDonorSuccess = createAction(ADD_DONOR_SUCCESS,props<{inputData: Donor}>())

export const updateDonor = createAction(UPDATE_DONOR,props<{inputData: Donor}>())
export const updateDonorSuccess = createAction(UPDATE_DONOR_SUCCESS,props<{inputData: Donor}>())

export const deleteDonor = createAction(DELETE_DONOR,props<{donorId:string}>())
export const deleteDonorSuccess = createAction(DELETE_DONOR_SUCCESS,props<{donorId:string}>())
