...
export const addRecipient = createAction(ADD_RECIPIENT,props<{inputData: Recipient}>())
export const addRecipientSuccess = createAction(ADD_RECIPIENT_SUCCESS,props<{inputData: Recipient}>())

export const updateRecipient = createAction(UPDATE_RECIPIENT,props<{inputData: Recipient}>())
export const updateRecipientSuccess = createAction(UPDATE_RECIPIENT_SUCCESS,props<{inputData: Recipient}>())

export const deleteRecipient = createAction(DELETE_RECIPIENT,props<{recipientId:string}>())
export const deleteRecipientSuccess = createAction(DELETE_RECIPIENT_SUCCESS,props<{recipientId:string}>())
